...
Original file is located at
    https://colab.research.google.com/drive/1M_pMYR1aDxwlRDYDbX33krrnSSJdi21q
"""
...
most_pop=df_tracks.query('popularity>20',inplace=False).sort_values('popularity',ascending=False)
most_pop[:10]
...
heatmap.set_title("correlation Heatmap betn variable")
heatmap.set_xticklabels(heatmap.get_xticklabels(),rotation=90)

sample_df=df_tracks.sample(int(0.2*len(df_tracks)))
print(len(sample_df))
